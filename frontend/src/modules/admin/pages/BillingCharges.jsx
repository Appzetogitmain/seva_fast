                    ...
                    {deliveryMode === 'distance' && (
                        <Card className="border-none shadow-xl ring-1 ring-slate-100 bg-white rounded-[32px] overflow-hidden text-left">
                            ...
                            <div className="p-8 space-y-8">
                                ...
                                {/* Delivery fee remainder after rider payout */}
                                <div className="pt-6 border-t border-slate-100">
                                    <h4 className="text-xs font-black text-slate-800 uppercase tracking-wider mb-1">
                                        Delivery Fee Remainder
                                    </h4>
                                    <p className="text-[10px] font-bold text-slate-400 italic mb-4">
                                        The rider is always paid first, in full. Whatever's left over from what the customer paid for delivery
                                        goes entirely to admin — sellers no longer receive a share of the delivery fee.
                                    </p>
                                </div>
