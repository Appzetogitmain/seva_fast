...
export const sellerApi = {
    ...
    checkApprovalStatus: (params) => axiosInstance.get('/seller/approval-status', { params: { ...params, _t: Date.now() } }),
    ...
    sendPasswordResetOtp: (data) => axiosInstance.post('/seller/forgot-password/send-otp', data),
    verifyPasswordResetOtp: (data) => axiosInstance.post('/seller/forgot-password/verify-otp', data),
    ...
    getProfitSummary: () => axiosInstance.get('/seller/profit-summary'),
    ...
    confirmShiprocketReturnReceipt: (orderId, data) => axiosInstance.put(`/orders/returns/${orderId}/confirm-shiprocket-receipt`, data),
